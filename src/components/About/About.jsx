    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-6 relative z-10">
        ...
        <div className="md:w-1/2 space-y-6">
          ...
          {/* Top badge – forced single line on large screens */}
          <span className="inline-flex items-center gap-2 bg-green-900/40 px-4 py-1 rounded-full text-sm whitespace-nowrap">
          ...
          <div className="flex flex-wrap gap-3 text-sm text-gray-300">
            ...
            <span className="px-3 py-1 border border-green-400/40 rounded-full">
              📍 Pune, Maharastra | Willing to Relocate
            </span>
          </div>

          {/* Education highlight */}
          <p className="text-green-300 font-semibold text-sm">
            MCA Graduate 2025 · 8.5 CGPA · DY Patil University
          </p>
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <a
              href="#contact"
              className="bg-green-400 text-black px-6 py-3 rounded-lg font-semibold hover:bg-green-300 transition inline-block"
            >
              Get in Touch
            </a>
            ...
            <a
              ...
              className="border border-green-400 text-green-400 px-6 py-3 rounded-lg font-semibold hover:bg-green-400 hover:text-black transition"
            >
              View Resume
            </a>
          </div>
        ...
        <div className="md:w-1/2 mt-12 md:mt-0 flex justify-center relative">
          ...
          {/* floating tech icons */}
          <FaReact className="absolute -top-6 left-10 text-green-400 text-3xl animate-pulse" />
          <FaPython className="absolute top-10 -left-6 text-green-400 text-3xl animate-pulse" />
          <FaDatabase className="absolute bottom-10 -left-4 text-green-400 text-3xl animate-pulse" />
          <FaCogs className="absolute bottom-0 right-6 text-green-400 text-3xl animate-pulse" />
